    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card className="overflow-hidden bg-card/80 backdrop-blur p-0">
                ...
                <span className="bg-card/0 relative z-10 px-2">
                  Or continue with
                </span>
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                                <Button variant="outline" type="button" className="w-full" aria-label="Login with Apple">
                                ...
                                <Button variant="outline" type="button" className="w-full" aria-label="Login with Meta">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4">
                                        <path
